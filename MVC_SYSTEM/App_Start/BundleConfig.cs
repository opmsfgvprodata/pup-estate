    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                        ...
                        "~/Asset/Scripts/fileinput.min.js"
                         ));
            ...
            bundles.Add(new ScriptBundle("~/bundles/MyCustomeJs").Include(
                       "~/Asset/Scripts/moment-with-locales.js",
            ...
            bundles.Add(new ScriptBundle("~/bundles/DateTimePickerJS2").Include(
                       "~/Asset/DateTimePickerV2/js/bootstrap-datetimepicker.js"));

            bundles.Add(new StyleBundle("~/Content/DateTimePickerCSS2").Include(
                      "~/Asset/DateTimePickerV2/css/bootstrap-datetimepicker.css"));
