...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class CheckRollFGVController : Controller
    {
        ...
        public ActionResult WorkingDetails()
        {
            ...
            var CheckLastDataKeyIn = dbr.tbl_Kerja.Join(dbr.tbl_Pkjmast, j => new { j.fld_Nopkj, j.fld_NegaraID, j.fld_SyarikatID, j.fld_WilayahID, j.fld_LadangID }, k => new { k.fld_Nopkj, k.fld_NegaraID, k.fld_SyarikatID, k.fld_WilayahID, k.fld_LadangID }, (j, k) => new { j.fld_Tarikh, j.fld_NegaraID, j.fld_SyarikatID, j.fld_WilayahID, j.fld_LadangID, j.fld_Nopkj, k.fld_DivisionID }).Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID && x.fld_DivisionID == DivisionID && x.fld_Tarikh.Value.Year == date.Value.Year && x.fld_Tarikh.Value.Month == date.Value.Month).OrderByDescending(o => o.fld_Tarikh).Select(s => s.fld_Tarikh).FirstOrDefault();
            ...
            var isCheckrollBlock = EstateFunction.isCheckrollBlock(timezone.gettimezone(), CheckLastDataKeyIn.Value, int.Parse(CheckBlockKeyInDay), NegaraID, SyarikatID, WilayahID, LadangID, DivisionID);
            ...
            //var CheckBlockStatus = db.tbl_BlckKmskknDataKerja.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID && x.fld_DivisionID == DivisionID && x.fld_Year == date.Value.Year && x.fld_Month == date.Value.Month).FirstOrDefault(); //edit by wani 18.6.2021
            ...
            //    tbl_BlckKmskknDataKerja.fld_DivisionID = DivisionID; //add by wani 18.6.2021
        ...
        public ActionResult CheckRollBlock(int msg)
        {
            ...
            {
                case 1:
                    //Message = "Data entry still blocked by HQ."; //Comment by fitri 8.2.2022
                    Message = "Please refer admin, Check-roll are Locked for not key-in daily.";
                    break;
                case 2:
                    //Message = "Data entry are blocked. (" + CheckBlockKeyInDay + " days not data entry)."; //Comment by fitri 8.2.2022
                    Message = "Please refer admin, Check-roll are Locked for not key-in daily transactions more than " + CheckBlockKeyInDay + " days."; //Add by fitri 8.2.2022
                    break;
            }
        ...
        public ActionResult Attendance(CustMod_Attandance CustMod_Attandance, string[] SaveWorkerNo)
        {
            ...
            try
            {
                ...
                var isActionLocked = EstateFunction.isActionLocked(CustMod_Attandance.dateseleted, timezone.gettimezone(), dackDatedDay, NegaraID, SyarikatID, WilayahID, LadangID, DivisionID);
            ...
            if (string.IsNullOrEmpty(idpengurus) == false && string.IsNullOrEmpty(passpengurus) == false)
            {
                ...
                if (pengurus != null)
                {
                    try
                    {
                        ...
                        var dackDatedDay = int.Parse(db.tblOptionConfigsWebs.Where(x => x.fldOptConfFlag1 == "backdatedkeyin" && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fldDeleted == false).Select(s => s.fldOptConfValue).FirstOrDefault());
                        var isActionLocked = EstateFunction.isActionLocked(CustMod_HariTerabai.dateseleted, timezone.gettimezone(), dackDatedDay, NegaraID, SyarikatID, WilayahID, LadangID, DivisionID);
        ...
        public ActionResult Working(DateTime SelectDate, string SelectionData, int SelectionCategory, string Lejar, byte JnisPkt, string PilihanPkt, string JnisAktvt, string PilihanAktvt, string NNCC, string SelectionNNCC, string SAPPilihanAktvt, decimal? HrgaKwsnSkr, string KdKwsnSkr, int AppKwnsSkrLainID, DateTime? AppKwnsSkrLainDT, int Division, List<CustMod_Work> HadirData)
        {
            ...
            bodyview = RenderRazorViewToString("WorkRecordList", EstateFunction.RecordWorkingList(dbr, SelectionCategory, SelectionData, SelectDate, NegaraID, SyarikatID, WilayahID, LadangID, DivisionID), false);
            dbr.Dispose();
        ...
        public JsonResult DeleteAttInfo(Guid Data, int SelectionCategory, string SelectionData, DateTime SelectDate, int Division)
        {
            ...
            var isActionLocked = EstateFunction.isActionLocked(SelectDate, timezone.gettimezone(), backDatedDay, NegaraID, SyarikatID, WilayahID, LadangID, Division);
        ...
        public JsonResult WorkerDateChecking(int SelectionCategory, string SelectionData, DateTime SelectDate, int Division)
        {
            ...
            var dackDatedDay = int.Parse(db.tblOptionConfigsWebs.Where(x => x.fldOptConfFlag1 == "backdatedkeyin" && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fldDeleted == false).Select(s => s.fldOptConfValue).FirstOrDefault());
            var isActionLocked = EstateFunction.isActionLocked(SelectDate, timezone.gettimezone(), dackDatedDay, NegaraID, SyarikatID, WilayahID, LadangID, Division);
        ...
        public JsonResult GetNNCC_V2(string JnisAktvt, byte JnsPkt, string PilihanPkt)
        {
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
            int? DivisionID = 0;
            int? getuserid = getidentity.ID(User.Identity.Name);
            ...
            else
            {
                ...
                var KodActvtList = db.tbl_UpahAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_KodJenisAktvt == JnisAktvt && x.fld_Deleted == false).ToList();
        ...
        public JsonResult GetAktvt_V2(string NNCCSelection, string JnisAktvt, string SelectionNNCC, string SAPPilihanAktvt, int Purpose, int HTPurpose)
        {
            ...
            if (Purpose == 1)
            {
                if (HTPurpose == 1)
                {
                    var KodActvtList = db.tbl_UpahAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_KategoriAktvt == NNCCSelection && x.fld_DisabledFlag == 3 && x.fld_Deleted == false).ToList();
                    if (SelectionNNCC == "1")
                    {
                        KodActvt = new SelectList(KodActvtList.OrderBy(o => o.fld_KodAktvt).Select(s => new SelectListItem { Value = s.fld_KodAktvt, Text = s.fld_KodAktvt + " - " + s.fld_Desc }), "Value", "Text").ToList();
                    }
                ...
                {
                    var KodActvtList = db.tbl_UpahAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_KategoriAktvt == NNCCSelection && x.fld_Deleted == false).ToList();
                    if (SelectionNNCC == "1")
                    {
                        KodActvt = new SelectList(KodActvtList.OrderBy(o => o.fld_KodAktvt).Select(s => new SelectListItem { Value = s.fld_KodAktvt, Text = s.fld_KodAktvt + " - " + s.fld_Desc }), "Value", "Text").ToList();
                    }
            ...
            else
            {
                ...
                {
                    var KodActvtList = db.tbl_UpahAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_KategoriAktvt == NNCCSelection).ToList();
                    KodActvt = new SelectList(KodActvtList.OrderBy(o => o.fld_KodAktvt).Select(s => new SelectListItem { Value = s.fld_KodAktvt, Text = s.fld_KodAktvt + " - " + s.fld_Desc }), "Value", "Text").ToList();
                    var KodActvtDesc = KodActvtList.Select(s => s.fld_KodAktvt).ToArray();
                    AktivitiToolTip = db.tbl_UpahAktiviti.Where(x => KodActvtDesc.Contains(x.fld_KodAktvt) && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID).OrderBy(o => o.fld_KodAktvt).Select(s => new { Label = s.fld_KodAktvt + " - " + s.fld_Desc + " - RM" + s.fld_Harga }).ToList();
                }
        ...
        public JsonResult GetForm_V2(int SelectionCategory, string SelectionData, byte JnisPkt, string PilihanPkt, string JnisAktvt, string KodAktvt, DateTime SelectDate, string NNCC, int Division)
        {
            ...
            string ActvtCodeSAP = "";
            int? KumpulanID = 0;
            int? jenisbayaran = 0; //added by faeza 13.02.2023
            ...
            if (JnisAktvt == "E")
            {
                CustMod_NNActCode = EstateFunction.GetNNActCode(dbr, PilihanPkt, KodAktvt, NNCC, NegaraID, SyarikatID, WilayahID, LadangID, DivisionID);
                    ...
                    if (kadarharga != 0)
                    {
                        if (SelectionCategory == 1)
                        {
                            ...
                            foreach (var checkatt in checkatts)
                            {
                                ...
                                var GetDailyRate = db.tblOptionConfigsWebs.Where(x => x.fldOptConfFlag1 == "kadarot" && x.fldOptConfFlag2 == "1" && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fldDeleted == false).Select(s => s.fldOptConfValue).FirstOrDefault();
                                ...
                                //modified by faeza 13.02.2023 - add jenis bayaran n avgsalary
                                CustMod_AttWorkList.Add(new CustMod_AttWork() { Nopkj = checkatt.fld_Nopkj, Namapkj = checkatt.fld_Nama, Keteranganhdr = keteranganhdr, statushdr = statushdr, disabletextbox = tbl_JenisAktiviti.fld_DisabledFlag, Kadar = kadarharga, KadarByrn = KadarByrn, KdhByr = tbl_JenisAktiviti.fld_KdhByr, Unit = tbl_JenisAktiviti.fld_Unit, MaximumHsl = tbl_JenisAktiviti.fld_MaxProduktiviti, DailyInsentif = DailyInsentif, NegaraID = checkatt.fld_NegaraID, SyarikatID = checkatt.fld_SyarikatID, jenisbayaran = jenisbayaran, avgsalary = decimal.Parse(GetLastMonthAverageSalary.ToString()), Kdhdct = checkatt.fld_Kdhdct });
                            }
                        }
                        else
                        {
