...
namespace MVC_SYSTEM.MasterModels
{
    ...
    public partial class tblOptionConfigsKiraOTViewModel
    {
        ...
        [Required(ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgModelValidation")]
        [Range(0, 9999999.9, ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgMaxCurrencyModelValidation")]
        [RegularExpression("^\\d+(?:\\.\\d{1,1})?$", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgNumberModelValidation")]
        [StringLength(50)]
        public string fldOptConfValue { get; set; }
    ...
    public partial class tblOptionConfigsWebIncentiveEligibilityViewModel
    {
        ...
        [Required(ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgModelValidation")]
        [Remote("IsIncentiveEligibilityExist", "Maintenance", AdditionalFields = "fldOptConfFlag2", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "MsgModelValidationIncentiveEligibilityExist")]
        [StringLength(50)]
        public string fldOptConfValue { get; set; }
    ...
    public partial class tblOptionConfigsWebBlokUpdate
    {
        ...
        [Required(ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgModelValidation")]
        [Range(0, 30, ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgMaxSmallIntegerModelValidation1")]
        [RegularExpression("^[0-3][0-9]*$", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgNumberModelValidation")]
        [StringLength(50)]
        public string fldOptConfValue { get; set; }
