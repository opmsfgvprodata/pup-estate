...
namespace MVC_SYSTEM.MasterModels
{
    ...
    public partial class tbl_CutiMaintenanceViewModelCreate
    {
        ...
        [Required(ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgModelValidation")]
        [Range(0, 9999999, ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgMaxLargeIntegerModelValidation")]
        [RegularExpression("^\\d+(?:)?$", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgNumberModelValidation")]
        public int? fld_LowerLimit { get; set; }
